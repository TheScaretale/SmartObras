        ...
        <div class="row">
            <div class="col-md-5 col-lg-3 text-center">
                ...
                <div class="">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="ratings" style="margin-left: 40px;">
            ...
            <div class="card-body">
                     <p class="d-inline-flex gap-1">
                         <a class="btn btn-primary" data-bs-toggle="collapse" href="#atividades" role="button" aria-expanded="false" aria-controls="atividades">
                            Atividades
</a>
                     </p>
